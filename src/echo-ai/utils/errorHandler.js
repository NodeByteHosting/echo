/**
 * Standardized error handling utilities for AI system
 */
...
/**
 * Handle errors in agent processing methods
 * @param {Error} error - The caught error
 * @param {Object} context - Context information
 * @param {string} source - Source of the error (agent/component name)
 * @returns {Object} Error response object
 */
export function handleAgentError(error, context = {}, source = 'agent') {
    // Log the error
